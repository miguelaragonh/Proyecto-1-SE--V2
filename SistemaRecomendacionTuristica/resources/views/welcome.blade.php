...
<div class="card">
    ...
    <div class="card__content" id="content">
        ...
        <div class="card__info" id="location-text">
            ...
            <button class="card__price text--medium button-info" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
...
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" data-descripcion="" id="cls"></button>
@endsection
@section('modal-tbody')
<p id="Descripcion"></p>
@endsection
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        switch(data){
            ...
            body.forEach(function(body) {
                ...
                body.style.background = 'linear-gradient(315deg, rgba(131,235,237,1) 0%, rgba(42,137,242,1) 53%, rgba(203,234,249,1) 100%)';
            });
            ...
            body.forEach(function(body) {
                ...
                body.style.background = 'linear-gradient(328deg, rgba(17,57,11,1) 0%, rgba(23,144,80,1) 61%, rgba(140,198,50,1) 100%)';
            });
            ...
            body.forEach(function(body) {
                ...
                body.style.backgorund = 'linear-gradient(301deg, rgba(255,255,255,1) 0%, rgba(96,101,98,1) 60%, rgba(255,255,255,1) 100%)';
            });
